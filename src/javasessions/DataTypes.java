...
public class DataTypes {
	...
	public static void main(String[] args) {
		...
		//data types:
		//1. Primitive data types: no need to create an object 
		
		//2. nonprimative data types: String,Class, Interfaces,Arrays, Object
		...
		//Numeric type:
		     ...
		     //character type: char ---> we can store in int, byte, short, long
		...
		b = 20;
		b = 30;
		byte b1 = 40;          // duplicate variable is not allowed in java
		byte b2 = -30;
		byte b3 = - 128;
		byte b4 = 0;
		byte age =30;
		...
		long l = 1002926778;
		long l1 = 9877653976L; // ---> telling to compiler it is only a long number 
