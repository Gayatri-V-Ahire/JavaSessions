...
public class StringConctenation {
	...
	public static void main(String[] args) {
		...
		//String - class in java(default class)
		 //String is collaction of multiple charactors
		...
		System.out.println(t+c+'b');//Helloa
	    ...
	    System.out.println("the value p and q is:" +(p+q));
